import { Component, html, classNames, HashRouter, reactive } from "../deps.ts"
import { isAuthenticated, fetchTags } from "../../state.ts"
                    ...
                    <div class="col-md-8">
                        <div class="feed-toggle">
                            ...
                            `)}
                                ...
                                ${this.pathParams.tag ? html`
                                <li class="nav-item" v-if="tag">
                                    <a
                                    href=${"/tag/" + this.pathParams.tag}
                                    class=${this.#getClassName('/tag/' + this.pathParams.tag)}
                                    >
